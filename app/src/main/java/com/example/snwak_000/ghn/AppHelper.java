/**
 * Created by snwak_000 on 2017-11-12.
 */
...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-east-2_65IOW9Ae2";

    /**
     * Add you app id
     */
    private static final String clientId = "52k1b6j0d510ct01ni043sn982";
     ...
     */
    private static final String clientSecret = "ofckr0t3l69qcld2sp3upus2sgi01oivgc7jc7lmf7or1k4nh6f";
    ...
    public static void setPhoneVerified(boolean verification) {
        phoneVerified = verification;
    }

    public static void setEmailVerified(boolean verification) {
        emailVerified = verification;
    }

    public static void setPhoneAvailable(boolean verification) {
        phoneAvailable = verification;
    }

    public static void setEmailAvailable(boolean verification) {
        emailAvailable = verification;
    }
    ...
    private static void setData() {
        ...
        attributeDisplaySeq.add("username");
        ...
        signUpFieldsC2O.put("Date of birth", "date of birth");
